...
<body>
	...
	<!-- end step header -->
					<div class="bs-stepper-content" style="margin-left: 13%;">
							...
							<!-- step 3 -->
							<div id="test-l-3"  class="content active">
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row row-size">
									...
									<div class="col-md-8">
										<span> <bean:write name="bookingForm"
												property="ngayDen" /> </span> <a class="linkchange" href="#">Thay
											đổi</a>
									</div>
								</div>
								<!-- end row 4:  ngày đến -->
								<div class="row row-size">
									...
									<div class="col-md-8">
										<span><bean:write name="bookingForm" property="ngayDi" /> </span> <a class="linkchange" href="#">Thay
											đổi</a>
									</div>
								</div>
								<!-- end row 5:  ngày đi -->
								<div class="row row-size">
									...
									<div class="col-md-8">
										<span> <bean:write name="bookingForm" property="soDem" /> </span> <span class="space">ĐÊM </span>
									</div>
								</div>
								<!-- end row 6:  số đêm -->
								<div class="row row-size">
								...
								<logic:iterate id="dsLoaiPhongDaChon" name ="bookingForm" property="listLoaiPhongDaChon">
								<div class="row">
									<div class="col-md-3">
									...
									<div class="col-md-4">
										...
										<a  class="xemthem" data-malp="${dsLoaiPhongDaChon.maLoaiPhong }" href="" data-toggle="modal" data-target=".xemthemmd" data-whatever="@getbootstrap">xem thêm</a>
									</div>
									<div class="col-md-3">
										<p class="step3"></p>
									</div>
								...
								<div class="row">
									<html:link styleClass="linkchange fa fa-chevron-left" action="booking-step2.do">Thay đổi
										phòng</html:link>
								</div>
								<!-- end danh sách phòng đã đặt -->
								<div class="row"
									...
									<div class="row" style="width: 100%; padding: 10px;">
										...
										<html:form action="booking-step4" styleId="form-step3" style="width: 100%;" method="POST">
									<div class="row" style="width: 100%; padding: 10px;">
										<div class="col-md-4 form-group">
											<html:text property="hoTenKH" styleClass="form-control" styleId="hoTenKH"></html:text>
										</div>
										<div class="col-md-4 form-group">
											<html:text property="soDT" styleClass="form-control" styleId="sodientoai"></html:text>
										</div>
										<div class="col-md-4 form-group">
									...
									<div class="row" style="width: 100%; padding: 10px;">
										<div class="col-md-3" style="margin-left: 90%;">
											<html:submit styleClass="btn btn-primary btn-step3"  >Next</html:submit>
										</div>
									</div>
									</html:form>
								</div>
