...
<body>
	...
	<div class="main-panel ps-container ps-theme-default"
		...
		<div class="col-md-12">
			<div class="card card-plain">
				<div class="card-header card-header-primary">
					<h4 class="card-title mt-0">Danh Sách Khách Hàng Đặt Phòng</h4>
				</div>
				<div class="row">
					<div class="col-md-3">
						<html:form styleClass="form-inline ml-auto form-search"
							action="danh-sach-booking">
							<div class="form-group has-white">
								...
								<html:hidden property="bookorcheck" value="book" />
								
								<html:submit
									styleClass="btn    btn-primary btn-sm ">Tìm Kiếm</html:submit> 
						...
						<div class="dropdown-booking">
							...
							<div class="dropdown-menu booking" id="bookingdiv"
								...
								<logic:iterate id="dsKhachSan" name="danhSachBookingForm"
									...
									<html:link action="/danh-sach-booking?maKS=${maks}">
										<p class="tenks">
											<bean:write name="tenks" />
										</p>
									</html:link>
					...
					<div class="table-responsive">
						<table id="#myTable" class="table table-hover">
							...
							<tbody>
								...
								<logic:iterate id="dsBooking" name="danhSachBookingForm"
									property="listBooking">
									<tr>
										<td id="bookingid"><bean:write name="dsBooking"
												property="bookingID" /></td>
										<td id="tenkh"><bean:write name="dsBooking"
												property="tenKH" /></td>
										<td><bean:write name="dsBooking" property="sdt" /></td>
										...
										<td style="text-align: center;"><html:link
												action="chi-tiet-booking?bookingID=${dsBooking.bookingID}">
												<span class="fa fa-id-card-o fa-2x" aria-hidden="true"
													data-toggle="modal" data-target="#xemchitiet"
													data-whatever="@getbootstrap"> </span>
											</html:link></td>
										...
										<td style="text-align: center;"><a href="#"><span
												class="fa fa-trash fa-2x xoa-booking"
												style="cursor: pointer;" aria-hidden="true"></span></a></td>
									</tr>
								</logic:iterate>
							</tbody>
						</table>
		...
		<div class="modal fade bd-example-modal-lg edit-info" tabindex="-1"
						...
						<form>
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label class="bmd-label-floating">Tên Khác Hàng </label> <input
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<div class="dropdown-booking" style="margin-top: -15px;">
											<button class="btn btn-block btn-primary dropdown-toggle"
												data-toggle="dropdown" id="tenks-dropdown">Chọn
												Khách Sạn</button>
											<div class="dropdown-menu booking" id="bookingdiv"
												style="padding-left: 15px;">
								...
								<div class="col-md-6" style="margin: auto;">
									<div class="dropdown-booking">
										<button class="btn btn-block btn-primary dropdown-toggle"
											data-toggle="dropdown" id="loaiphong">Chọn Loại
											Phòng</button>
										<div class="dropdown-menu booking" id="bookingdiv"
											style="padding-left: 15px;">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<div class="form-group">
											<label class="bmd-label-floating">Ngày Đến</label> <input
												type="text" class="form-control datetimepicker" id="ngayden"
												value="">
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="form-group">
											<label class="bmd-label-floating">Ngày Đi</label> <input
												type="text" class="form-control datetimepicker" id="ngaydi"
												value="">
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label class="bmd-label-floating">Số Lượng Phòng</label> <input
											type="text" class="form-control">
									</div>
								</div>
								<!-- end Sô Lượng Phòng -->
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label class="bmd-label-floating">Giá Tiền(Ngày Đêm)</label> <input
								...
								<div class="col-md-4">
									<div class="form-group">
										<label class="bmd-label-floating">Số Tiền Đã Cộc</label> <input
											type="text" class="form-control">
									</div>
								</div>
								<!-- end input Tổng Tiền -->
							</div>
							<button type="submit" class="btn btn-primary pull-right">Thay
								Đổi</button>
